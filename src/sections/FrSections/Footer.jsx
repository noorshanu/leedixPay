        ...
        <div className=" flex flex-col sm:flex-row gap-4  justify-between items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 ">
            ...
            <div className=" flex items-center gap-4 text-white">
              <a href="https://twitter.com/LEEDIXPAY" target="_blank" className=" text-xl  hover:text-[#1a4093]">
                <BsTwitterX />
              </a>
              ...
              <a href="https://www.facebook.com/Leedixpay?mibextid=hu50Ix" target="_blank" className=" text-xl hover:text-[#1a4093]">
                <BsFacebook />
              </a>
{/* 
              <a href="/" className=" text-xl hover:text-[#1a4093]">
              ...
              <a href="https://t.me/leedixpayapp" target="_blank" className=" text-xl hover:text-[#1a4093]">
                <FaTelegram />
              </a>
            </div>
          </div>
